    ...
    const fetchData = async () => {
      ...
      try {
        const [
          ...
          axios.get('http://192.168.1.4:5000/api/users'),
          axios.get('http://192.168.1.4:5000/api/products'),
          axios.get('http://192.168.1.4:5000/api/orders'),
          axios.get('http://192.168.1.4:5000/api/orderItems'),
        ]);
